...
import {getDetailOrder,getPayOrder} from  '../actions/orderAction'
import {ORDER_PAY_RESET} from '../constents/orderConstant'
      ...
      <Col md={8}>
        <ListGroup variant='flush'>
          <ListGroup.Item>
            ...
            {order.isDelivered ? (
              <Message variant='success'>isDelivered on {order.DeliveredAt}</Message>
            ):(
